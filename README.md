...
[**Find PI to the Nth Digit**](https://github.com/Dglgmut/Projects/blob/master/Numbers/pi.scala) - Enter a number and have the program generate PI up to that many decimal places. Keep a limit to how far the program will go.

[**Fibonacci Sequence**](https://github.com/kapok/Projects/blob/master/Numbers/fibonacci.scala) - Enter a number and have the program generate the Fibonacci sequence to that number or to the Nth number.

[**Prime Factorization**](https://github.com/kapok/Projects/blob/master/Numbers/prime_factorization.scala) - Have the user enter a number and find all Prime Factors (if there are any) and display them.

[**Next Prime Number**](https://github.com/kapok/Projects/blob/master/Numbers/next_prime_number.scala) - Have the program find prime numbers until the user chooses to stop asking for the next one.

[**Find Cost of Tile to Cover W x H Floor**](https://github.com/kapok/Projects/blob/master/Numbers/cost_of_tile.scala) - Calculate the total cost of tile it would take to cover a floor plan of width and height, using a cost entered by the user.

[**Mortgage Calculator**](https://github.com/kapok/Projects/blob/master/Numbers/mortgage.scala) - Calculate the monthly payments of a fixed term mortgage over given Nth terms at a given interest rate. Also figure out how long it will take the user to pay back the loan.

[**Change Return Program**](https://github.com/kapok/Projects/blob/master/Numbers/change_return.scala) - The user enters a cost and then the amount of money given. The program will figure out the change and the number of quarters, dimes, nickels, pennies needed for the change.
...
[**Count Vowels**](https://github.com/kapok/Projects/blob/master/Text/count_vowel.scala) - Enter a string and the program counts the number of vowels in the text. For added complexity have it report a sum of each vowel found.

[**Check if Palindrome**](https://github.com/kapok/Projects/blob/master/Text/palindrome.scala) - Checks if the string entered by the user is a palindrome. That is that it reads the same forwards as backwards like “racecar”

[**Count Words in a String**](https://github.com/kapok/Projects/blob/master/Text/count_words.scala) - Counts the number of individual words in a string. For added complexity read these strings in from a text file and generate a summary.
